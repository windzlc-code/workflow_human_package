...
async function insertTikTokItems(items, { keyword, proxyUrl = "", enrich = true, maxDeepPages = 0, domainControls = {}, contentControls = {}, seenItemUrls = null }) {
  ...
  for (const item of items) {
    ...
    const content = enriched.content || item.content || "";
      ...
      evidence: {
        ...(enriched.evidence || {}),
	        evidence_type: enriched.evidence?.evidence_type || "tiktok_public_video_search_result",
	        metrics: {
	          ...finalMetrics,
...
export async function scrapeTikTokSearch(keywords, { proxyUrl = "", enrich = true, budget = {}, deepBudget = null, since = "", domainControls = {}, contentControls = {} } = {}) {
