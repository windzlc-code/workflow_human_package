...
function insertBilibiliVideo(item, { keyword, rawJson = null, domainControls = {}, contentControls = {}, seenItemUrls = null }) {
  ...
  const result = insertSentimentItem({
    ...
    raw_html: rawJson ? JSON.stringify(rawJson).slice(0, 20000) : "",
    ai_summary: item.content,
    evidence: {
      evidence_type: "bilibili_video_search_result",
      metrics: {
        ...(item.metrics || {}),
...
export async function scrapeBilibiliSearch(keywords, { proxyUrl = "", budget = {}, since = "", domainControls = {}, contentControls = {} } = {}) {
