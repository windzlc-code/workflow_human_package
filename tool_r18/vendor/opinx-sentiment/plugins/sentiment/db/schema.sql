...
CREATE TABLE IF NOT EXISTS sentiment_opensearch_archive_outbox (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  ...
  archive_score REAL DEFAULT 0,
  archive_tier TEXT DEFAULT '',
