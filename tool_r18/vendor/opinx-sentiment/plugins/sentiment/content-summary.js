  ...
  while ((match = linkRegex.exec(source)) !== null) {
    ...
    const forceKind = /webmention|pingback|trackback|mention-endpoint/.test(relText)
      ...
      : /comments?|repl(?:y|ies)|discussion/.test(relText)
        ? "discussion"
        : /citation|source|bookmark|related/.test(relText)
          ? "source-reference"
      ...
      : /amphtml/.test(relText)
        ? "alternate-page"
        : "";
    if (/alternate|amphtml|feed|next|prev|related|citation|source|bookmark|webmention|pingback|trackback|comments?|repl(?:y|ies)|discussion/i.test(relText)) {
